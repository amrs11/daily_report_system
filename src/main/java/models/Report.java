...
public class Report {
     ...
     * 日報を登録した従業員
     */
    @ManyToOne //1人の従業員は複数の日報を持っている、という1対多といった関係性を紐づけるためのアノテーション
    ...
    private LocalDate reportDate;//日付のみで時間、秒数などは無い
     ...
     * 日報の内容
     */
    @Lob //フォームに入力された改行の情報もDBに保存してくれるアノテーション
